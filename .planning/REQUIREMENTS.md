...
- [ ] **FOUND-01**: Next.js 16 project scaffolded with App Router, Tailwind v4, Supabase client
...
- [ ] **FOUND-07**: Money stored as integer cents throughout, display formatting in UI only
