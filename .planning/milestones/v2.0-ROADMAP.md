...
- [x] 16-02-PLAN.md — Middleware extension for super admin routes + suspension page routing
- [x] 16-03-PLAN.md — Super admin layout, sidebar, tenant list, and tenant detail UI
