# Requirements Archive: v8.1 Marketing Refresh & Compare Page
...
- [x] **NAV-01**: Visitor can navigate to the comparison page from the landing page nav bar (desktop and mobile)
...
- [x] **NAV-04**: Footer includes links to comparison page and all add-on detail pages
