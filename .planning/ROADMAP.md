...
<details>
<summary>✅ v8.0 Add-On Catalog Expansion (Phases 35-37) — SHIPPED 2026-04-07</summary>

- [x] Phase 35: Gift Cards Add-On (7/7 plans) — completed 2026-04-06
- [x] Phase 36: Advanced Reporting / COGS Add-On (4/4 plans) — completed 2026-04-06
- [x] Phase 37: Loyalty Points Add-On (8/8 plans) — completed 2026-04-07
...
- [x] 38-02-PLAN.md — Landing page pricing/features/hero update + add-ons catalog expansion
...
- [ ] 39-03-PLAN.md — SEO retrofit (OG meta + JSON-LD) on all 5 add-on detail pages
**UI hint**: yes
...
| 39. Comparison Page + Nav/Footer/SEO | v8.1 | 0/3 | Not started | - |
