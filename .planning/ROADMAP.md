...
<details>
<summary>✅ v7.0 POS Demo (Phases 32-34) — SHIPPED 2026-04-06</summary>

- [x] Phase 32: Demo Store Seed (1/1 plans) — completed 2026-04-06
- [x] Phase 33: Demo POS Route & Checkout (2/2 plans) — completed 2026-04-06
- [x] Phase 34: Signup Conversion & Landing Page (2/2 plans) — completed 2026-04-06
...
- [x] 35-02-PLAN.md — Gift card issuance (POS + online + email + storefront nav)
- [x] 35-03-PLAN.md — POS redemption (cart state machine + payment method)
- [x] 35-04-PLAN.md — Online redemption (checkout gift card + Stripe bypass)
- [x] 35-05-PLAN.md — Admin management (list, detail, void)
**UI hint**: yes
...
**Plans:** 7 plans
Plans:
- [ ] 37-00-PLAN.md — Wave 0 RED test stubs (loyalty utils, cart state, server actions)
- [ ] 37-01-PLAN.md — DB schema, billing pipeline, admin nav, loyalty-utils
- [ ] 37-02-PLAN.md — Admin loyalty settings page (earn/redeem rates, pause toggle)
- [ ] 37-03-PLAN.md — POS customer lookup + cart state machine + UI components
- [ ] 37-04-PLAN.md — Points earning (POS completeSale + online webhook)
- [ ] 37-05-PLAN.md — Online checkout redemption + customer account profile
- [ ] 37-06-PLAN.md — Admin customer loyalty (points column, transaction history)
**UI hint**: yes
...
| 37. Loyalty Points Add-On | v8.0 | 0/7 | Not started | - |
