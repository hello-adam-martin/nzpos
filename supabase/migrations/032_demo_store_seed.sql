...
INSERT INTO public.categories (id, store_id, name, slug, sort_order) VALUES
  ('00000000-0000-4000-b000-000000000001', '00000000-0000-4000-a000-000000000099', 'Candles & Fragrance', 'candles-fragrance', 0),
  ('00000000-0000-4000-b000-000000000002', '00000000-0000-4000-a000-000000000099', 'Homewares', 'homewares', 1),
  ('00000000-0000-4000-b000-000000000003', '00000000-0000-4000-a000-000000000099', 'Prints & Art', 'prints-art', 2),
  ('00000000-0000-4000-b000-000000000004', '00000000-0000-4000-a000-000000000099', 'Kitchen & Dining', 'kitchen-dining', 3),
  ('00000000-0000-4000-b000-000000000005', '00000000-0000-4000-a000-000000000099', 'Jewellery & Accessories', 'jewellery-accessories', 4)
ON CONFLICT (id) DO NOTHING;
